    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl text-gray-900 mb-8 font-bold">
          ...
          <div className="border border-gray-300 p-8">
            ...
            <ul className="space-y-3 list-none">
              <li className="flex items-center">
                ...
                <span className="text-base text-gray-700"><strong>Strategy</strong> and <strong>storytelling</strong> alignment</span>
              </li>
              <li className="flex items-center">
                <div className="w-2 h-2 bg-gray-900 rounded-full mr-3 flex-shrink-0"></div>
                <span className="text-base text-gray-700">Scalable <strong>content production</strong></span>
              </li>
              <li className="flex items-center">
                <div className="w-2 h-2 bg-gray-900 rounded-full mr-3 flex-shrink-0"></div>
                <span className="text-base text-gray-700"><strong>Creator-first</strong> mindset</span>
              </li>
            </ul>
          </div>
        </div>
